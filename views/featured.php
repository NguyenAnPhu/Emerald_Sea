<div class="featured px-0">
    <div class="featured-content container-xl d-flex flex-column">
        <div class="banner w-100">
            <img class="w-100" src="assets/images/bannerFeatured.png" alt="">
        </div>
        <div class="title d-flex justify-content-between mx-0">
            <h3 class="mx-0">
